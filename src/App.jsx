...
function App() {
  ...
  return (
    <>
      ...
      >
        <div className={!darkMode?"container  bg-[#131216] px-10 py-5 shadow-[0px_0px_20px_0px_rgba(255,_255,_255,_0.15)]  w-[600px] h-[600px] mx-auto  rounded-xl flex items-center flex-col":"containerLight px-10 py-5 shadow-[3px_0px_30px_0px_rgba(255,_255,_255,_0.75)]  w-[600px] h-[600px] mx-auto  rounded-xl flex items-center flex-col"}>
          ...
          <div className=" w-full flex items-center mb-4 border-b">
            ...
            />
            <label className="mx-2 text-xs text-blue-600 font-medium" htmlFor="show">
              Show Finished
            </label>
          </div>
          ...
          <div className="todolist  text-white w-full overflow-y-auto overflow-x-hidden">
            {todos.length === 0 && (
              <div className={!darkMode?"text-zinc-400 text-sm":"text-zinc-600 text-sm"}>No tasks to display</div>
            )}
            {todos.map((item) => {
              return (
                (showFinished || !item.isCompleted) && (
                  <div
                    key={item.id}
                    className={!darkMode?"todo flex items-center w-full justify-between mb-2 bg-[#17161A] p-1.5 rounded-md" : "todo bg-[#50a7ffe8] flex items-center w-full justify-between mb-2 p-1.5 rounded-md"}
                  >
                    {/* CHECK BOX */}
